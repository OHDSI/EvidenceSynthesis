...
The results contain more than a summary table. Notably, it includes all retains MCMC samples for all parameters in the model. For example, MCMC samples for $\delta_1$, the source effect for data source $1$ can be extracted as follows:
```{r getMCMCsamples}
