...
We note that the input should include (1) profile likelihoods on the outcome of interest (e.g., `ooiLik5`), and (2) profile likelihoods (e.g., `ncLik5`) or the learned bias distributions. 
...
knitr::kable(bind_rows(bbcResult5 %>% mutate(biasCorrection = "yes"),
                       attr(bbcResult5, 'summaryRaw') %>% mutate(biasCorrection = "no")) %>%
               select(-Id), digits = 4)
```
